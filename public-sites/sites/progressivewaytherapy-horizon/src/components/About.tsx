      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-fade-in-up">
            <h2 className="section-title">Meet Blanca Kleinfall, M.Ed., LPC</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
              <div className="space-y-6">
                ...
                <h3 className="text-2xl font-serif text-soft-purple">
                ...
                <div className="grid sm:grid-cols-2 gap-4 pt-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Trauma & relationship therapy</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-sage-green mt-0.5 flex-shrink-0" />
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Trauma processing specialist</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-sage-green mt-0.5 flex-shrink-0" />
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Identity-supportive care</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-sage-green mt-0.5 flex-shrink-0" />
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Social justice focused</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-warm-tan/20 rounded-2xl p-6 border border-warm-tan/30">
                  <div className="flex items-start space-x-3">
                    <Users className="w-6 h-6 text-sage-green mt-1 flex-shrink-0" />
                    <div>
