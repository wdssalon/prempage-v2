...
Policy:
- Guardrails: obey `agents/policy/public-sites.md`; treat it as the canonical ruleset.
- Coordinator SOP: run the phases and gates defined in `agents/policy/public-sites.md`; this prompt only adds Horizon-specific clarifications.
...
- Template reference: consult `public-sites/templates/horizon/config.yaml` and `sections.yaml` for Horizon-specific guidance.
...
2. Run the phases defined in `agents/policy/public-sites.md` with the mandatory Visual System gate. Horizon-specific expectations include:
