      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-40">
            ...
            <ul className="flex items-center space-x-6">
              ...
              <li className="relative">
                ...
                {activeDropdown === "services" && (
                  <div className="absolute top-full left-0 mt-2 w-80 bg-surface rounded-md shadow-warm border border-border p-4">
              ...
              <li className="relative">
                ...
                {activeDropdown === "started" && (
                  <div className="absolute top-full left-0 mt-2 w-56 bg-surface rounded-md shadow-warm border border-border p-4">
                    <ul className="space-y-2">
                      <li>
                        <a href="/#appointment" className="block text-copy hover:text-brand-soft transition-colors">
                          Appointment Request
                        </a>
                      </li>
                      <li>
                        <a href="/#privacy" className="block text-copy hover:text-brand-soft transition-colors">
                          Privacy Practices
                        </a>
                      </li>
                      <li>
                        <a href="/#faq" className="block text-copy hover:text-brand-soft transition-colors">
                          FAQs
                        </a>
                      </li>
                      <li>
                        <a href="/#rates" className="block text-copy hover:text-brand-soft transition-colors">
                          Rates & Insurance
                        </a>
                      </li>
                    </ul>
          ...
          <div className="hidden xl:flex items-center">
            <button type="button" className="btn-primary is-compact">
