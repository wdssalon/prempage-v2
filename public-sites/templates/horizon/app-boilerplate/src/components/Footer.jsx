...
export default function Footer() {
  return (
    <footer data-section-id="global--footer" className="bg-base text-copy py-16">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                <div>
                  <h3 className="text-xl font-serif font-semibold text-brand-soft">Progressive Way Therapy</h3>
            ...
            <div>
              <h4 className="font-serif font-semibold mb-4 text-brand-soft">Quick Links</h4>
              <ul className="space-y-2 text-sm text-copy/80">
                <li><a href="/about" className="hover:text-brand-soft transition-colors">About Blanca</a></li>
                <li><a href="/#services" className="hover:text-brand-soft transition-colors">Our Services</a></li>
                <li><a href="/#emdr" className="hover:text-brand-soft transition-colors">EMDR Therapy</a></li>
                <li><a href="/#ketamine" className="hover:text-brand-soft transition-colors">Ketamine Treatment</a></li>
