...
export default function Services({ sectionId }) {
  return (
    <section id="services" data-section-id={sectionId} className="py-20 bg-base">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-brand-soft mb-2">EMDR Therapy</h4>
                ...
                <div className="flex items-start space-x-3">
                  <Heart className="w-6 h-6 text-brand-soft mt-1 shrink-0" />
                  <div>
                    <h4 className="font-semibold text-brand-soft mb-2">Ketamine-Assisted Psychotherapy</h4>
                    <p className="text text-sm text-muted leading-relaxed">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <Users className="w-6 h-6 text-brand-soft mt-1 shrink-0" />
                  <div>
                    <h4 className="font-semibold text-brand-soft mb-2">Liberation-Based Healing</h4>
                    <p className="text text-sm text-muted leading-relaxed">
                ...
                <div className="flex items-start space-x-3">
                  <Brain className="w-6 h-6 text-brand-soft mt-1 shrink-0" />
                  <div>
                    <h4 className="font-semibold text-brand-soft mb-2">Somatic & Nervous System Work</h4>
                    <p className="text text-sm text-muted leading-relaxed">
