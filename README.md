...
- `public-sites/` – Static site toolkit and exports. Start with `public-sites/README.md` for the map, then load `agents/guardrails.md`, `agents/coordinator.md`, and the template supplements when working on a site.
...
- Read `public-sites/README.md` for the quick-start map when pushing updates to the static export.
