...
- Regenerate TypeScript bindings with `pnpm openapi:types` from the active frontend workspace (`client/` for the Next.js Studio, `client-old/` while the legacy app remains).
